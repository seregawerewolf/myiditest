...
class Iceberg_Category_Form_Fields_Setup {
    ...
    protected $default_category_color = '#71b2e4';
    ...
    */	
    public function admin_enqueue_scripts() {
        ...
        if( $screen->base == 'edit-tags' || $screen->base == 'term' ) {
            ...
            wp_enqueue_script( 'iceberg-category-color-js',  get_template_directory_uri() . '/assets/js/admin/category-color.js', array( 'jquery' ), '1.0', true );
        }
    }
