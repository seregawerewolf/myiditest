	...
	<div class="content-container">
		...
		<?php if ( have_comments() ) : ?>
			...
			<h3 class="comments-title section-title">
				<?php printf( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'iceberg' ), number_format_i18n( get_comments_number() ), get_the_title() ); ?>
			</h3>
			...
			<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
				...
				<nav id="comment-nav-below" class="navigation comment-navigation" role="navigation">
					...
					<div class="nav-previous">
						<?php previous_comments_link( esc_html__( '&larr; Older Comments', 'iceberg' ) ); ?>	
					</div>

					<div class="nav-next">
						<?php next_comments_link( esc_html__( 'Newer Comments &rarr;', 'iceberg' ) ); ?>
					</div>
